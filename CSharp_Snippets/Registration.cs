    ...
    class Registration : Play
    {
        ...
        public void Play()
        {
            ...
            while (isInputGood == false)
            {
                ...
                else Console.WriteLine("To better serve our customers, names need to be longer than 5 characters.  Thank you{0}Reservation Name:", Environment.NewLine);
            }
